      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        ...
        >
          ...
          <h2 className="text-4xl md:text-6xl mb-6 text-white font-light tracking-tight">
            Nuestros <span className="text-[var(--gold-5)] font-normal italic">Proyectos</span>
          </h2>
          ...
          <p className="text-lg md:text-xl text-gray-400 max-w-2xl mx-auto font-light leading-relaxed">
            Descubre condominios campestres diseñados para quienes buscan el equilibrio perfecto entre lujo y naturaleza.
          </p>
        </motion.div>
