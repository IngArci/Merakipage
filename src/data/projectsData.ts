...
export const projectsData: Record<string, Project> = {
  'rio-claro': {
    ...
    status: 'en-venta',
    shortDescription: 'Un espacio donde podras vivir en medio de la naturaleza, un proyecto pensado para invertir, rentar o disfrutar con calidad de vida',
    ...
    location: {
      ...
      nearbyPlaces: [
        'A tan solo 15 minutos de Honda',
